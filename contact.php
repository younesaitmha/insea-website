<?php
    ...
    if(isset($_POST['mail']) && $_POST['mail'] != ''){
        if(filter_var($_POST['mail'], FILTER_VALIDATE_EMAIL)){
            $fName = $_POST['fname'];
            $Lname = $_POST['lname'];
            $emailVisitor = $_POST['mail'];
            $subject = $_POST['sub'];
            $message = $_POST['message'];

            $to = "younesmathss@gmail.com";
            $body = "";
            $body .= "From: ".$fName." ".$Lname."\r\n";
            $body .= "E-mail: ".$emailVisitor."\r\n";
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <?php if($send): ?>
      <div class="container">
          <div class="col-12">
            <h3 class="text-center" style="color: green;">l'email est envoyé</h3>
          </div>
        </div>
    <?php endif; ?>
        ...
        <form class="form" method="POST" action="">
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" id="fname" class="form-control form-control-lg" tabindex="1" required>
                </div>
                <div class="col-md-6 form-group">
                    <label for="lname">Last Name</label>
                    <input type="text" id="lname" class="form-control form-control-lg" tabindex="2" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label for="mail">Email Address</label>
                    <input type="email" id="mail" class="form-control form-control-lg <?= $v ?? "" ?>" tabindex="3" required style=".invalid-form {outline: 2px solid red !important;}">
                </div>
                <div class="col-md-6 form-group">
                    <label for="sub">Subject</label>
                    <input type="text" id="sub" class="form-control form-control-lg" tabindex="4" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 form-group">
                    <label for="message">Message</label>
                    <textarea name="" id="message" cols="30" rows="10" class="form-control" tabindex="5" required></textarea>
                </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
              ...
              <h3 data-aos="fade-down">Notre Philosophie</h3>
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
              ...
              <h3  data-aos="fade-down">Principe académique</h3>
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
              ...
              <h3 data-aos="fade-down">Clé du succès</h3>
              <p data-aos="fade-up">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reiciendis recusandae, iure repellat quis delectus ea?
                Dolore, amet reprehenderit.</p>
            </div>
          </div>
